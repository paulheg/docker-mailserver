...
!!! note "AMD64 vs ARM64"
    ...
    When running DMS on AMD64, we are using a PPA (that does not yet provide a package for ARM64) to get the very latest version. As a result, there is a version discrepancy. The current version difference as of 20th June 2023: AMD64 is at version 3.5 | ARM64 is at version 3.4.
